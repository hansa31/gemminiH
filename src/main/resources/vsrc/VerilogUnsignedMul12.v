// ============================================================================
// VerilogUnsignedMul12 wrapper for approximate multiplier: mul12u_2JV
// Auto-generated by batch_approx_uint12_fp16_fp32_verilator.sh on 2026-03-23 19:39:54
// Source: /home/hansa/Desktop/GemminiChipyard/chipyard/generators/gemmini/src/main/resources/vsrc/12x12_unsigned/pareto_pwr_mae/mul12u_2JV.v
//
// Used as the 12×12 unsigned mantissa multiplier in FP16 (sigWidth=11)
// floating-point multiplication via IntVerilogFloatMul (useIntVerilog=true).
// The Chisel side zero-extends both 11-bit significands to 12 bits before
// entering this BlackBox, and extracts only the lower 2×11=22 product bits.
// ============================================================================

// ==== Approximate multiplier definition (includes PDK primitives) ====
/***
...
// ==== VerilogUnsignedMul12 wrapper (matches Chisel BlackBox interface) ====
// Fixed 12×12 unsigned interface.  Zero-extension for narrower sigWidths is
// handled on the Chisel side (Cat(0.U(1.W), sig_x) for FP16 sigWidth=11).
module VerilogUnsignedMul12 (
  input  [11:0] a,
  input  [11:0] b,
  output [23:0] result
);
  mul12u_2JV approx_inst (.A(a), .B(b), .O(result));
endmodule
