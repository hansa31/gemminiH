// ============================================================================
// VerilogFloatMantissaMul wrapper for approximate multiplier: mul11u_041
// Auto-generated by batch_approx_fp16mul_fp32accum_int11u_bitstream.sh
//   on 2026-03-24 21:55:31
// Source: /home/hansa/Desktop/GemminiChipyard/chipyard/generators/gemmini/src/main/resources/vsrc/11x11_unsigned/pareto_pwr_mre/mul11u_041.v
//
// FP16 (expWidth=5, sigWidth=11) mantissa multiplication via INT11u path.
// Unsigned 11×11→22-bit product for FP16 mantissa multiplication.
// ============================================================================
...
// ==== VerilogFloatMantissaMul wrapper (matches Chisel BlackBox interface) ====
module VerilogFloatMantissaMul #(
  parameter SIGSZ = 11  // significand width including hidden bit (FP16 = 11)
)(
  input  [SIGSZ-1:0]    a,
  input  [SIGSZ-1:0]    b,
  output [2*SIGSZ-1:0]  result
);
  mul11u_041 approx_inst (
    .A(a),
    .B(b),
    .O(result)
  );
