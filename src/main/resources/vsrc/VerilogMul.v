// ============================================================================
// VerilogMul wrapper — approximate multiplier: mul8s_1L2J  precision: INT6
// Auto-generated by batch_approx_int46_bitstream.sh on 2026-03-27 12:41:59
// Source: /home/hansa/Desktop/GemminiChipyard/chipyard/generators/gemmini/src/main/resources/vsrc/8x8_signed/pareto_pwr_ep/mul8s_1L2J.v
// ============================================================================

// ==== EvoApprox multiplier core ====
/***
...
// ==== VerilogMul wrapper (matches Chisel BlackBox interface) ====
module VerilogMul #(
  parameter WIDTH     = 8,
  ...
  // INT6 truncation: sign-extend lower 6 bits back to 8.
  wire signed [7:0] a_in;
  wire signed [7:0] b_in;
  assign a_in = { {2{a[5]}}, a[5:0] };
  assign b_in = { {2{b[5]}}, b[5:0] };

  mul8s_1L2J approx_mul_inst (
    .A(a_in),
    .B(b_in),
    .O(result)
  );
